...
echo "  cryptsetup open $DEVICE $LUKS_NAME"
echo "  mount /dev/mapper/$LUKS_NAME /mnt"
echo ""
echo "To mount specific subvolumes:"
echo "  mount -o subvol=@ /dev/mapper/$LUKS_NAME /mnt"
echo "  mount -o subvol=@snapshot /dev/mapper/$LUKS_NAME /mnt/snapshots"
echo "  mount -o subvol=@data /dev/mapper/$LUKS_NAME /mnt/data"
